...
MySQL Workbench → modelagem e execução dos scripts SQL.

PowerShell → automação para consolidar arquivos .sql em um único arquivo de migration.

Git → versionamento e controle de alterações.
...
O arquivo migration.sql é aplicado no banco MySQL, criando tabelas, inserindo dados iniciais e configurando views.
